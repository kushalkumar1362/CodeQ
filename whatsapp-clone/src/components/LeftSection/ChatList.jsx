  ...
  return (
    <div className='scrollbar-thumb-[#202C33] scrollbar-track-[#111B21]'>
      <div className='mt-2 overflow-y-auto h-[calc(100vh-150px)] scrollbar-thin'>
        {listData.map((data) => (
          <div className='hover:bg-[#2A3942]' key={data.id}>
            <div
              className='flex items-center gap-3 py-2 px-4  cursor-pointer w-full
            '>
            ...
            <div className='w-[75%] mx-[22%] bg-[#2A3942] h-[1px]'></div>
          </div>
        ))}
